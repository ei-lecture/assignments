...
Da es sich hier um das Beispielthema handelt, ist die [Lösung](01_exercise_loesung.pdf) bereits erstellt worden; Sie müssen Sie also nur noch hochladen. Wenn Sie wollen, können Sie die Lösung auch noch überarbeiten oder verfeinern - verwenden Sie hierzu die entsprechende [Quelldatei](01_exercise_loesung.tex).
